...
namespace WebUwp.Views
{
    ...
    public sealed partial class UpdateUserPage : Page
    {
        ...
        public UpdateUserPage()
        {
            ...
            Loaded += UpdateUserPage_LoadedAsync;
        }



        private void UpdateUserPage_LoadedAsync(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
        ...
        private async void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (isFirstNameValid && isLastNameValid && isUsernameNameValid && isPasswordValid)
            {
                try
                {
                    ...
                    if (await ViewModel.UpdateUserAsync(FirstName.Text, LastName.Text, Username.Text, Password.Password).ConfigureAwait(true))
                    {
#pragma warning disable CA1303 // Do not pass literals as localized parameters
                        ExceptionBlock.Text = "Successfully Updated";
#pragma warning restore CA1303 // Do not pass literals as localized parameters
                    }
#pragma warning disable CA1303 // Do not pass literals as localized parameters
                    else ExceptionBlock.Text = "Updating Failed - Username may already exist";
#pragma warning restore CA1303 // Do not pass literals as localized parameters
                }
                catch (Exception ex)
                {

                    ExceptionBlock.Text = "Update Failed: " + ex;
                }
            }
            else
            {
