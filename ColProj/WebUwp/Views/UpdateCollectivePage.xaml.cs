...
namespace WebUwp.Views
{
    ...
    /// </summary>
    public sealed partial class UpdateCollectivePage : Page
    {
        ...
        public UpdateCollectivePage()
        {
            this.InitializeComponent();
            Loaded += UpdateCollectivePage_LoadedAsync;
        }



        private void UpdateCollectivePage_LoadedAsync(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            ViewModel.InternetConnectivity();
        }

        private async void UpdateCollective_Click(object sender, RoutedEventArgs e)
        {
...
#pragma warning disable CA1305 // Specify IFormatProvider
                    if (await ViewModel.UpdateCollectiveAsync(Name.Text, Description.Text, int.Parse(Size.SelectedItem.ToString())).ConfigureAwait(true))
#pragma warning restore CA1305 // Specify IFormatProvider
                    {
#pragma warning disable CA1303 // Do not pass literals as localized parameters
                        ExceptionBlock.Text = "Collective successfully updated!";
#pragma warning restore CA1303 // Do not pass literals as localized parameters
                    }
                    else
                    {
#pragma warning disable CA1303 // Do not pass literals as localized parameters
                        ExceptionBlock.Text = "Failed to update collective";
#pragma warning restore CA1303 // Do not pass literals as localized parameters
                    }
                ...
                catch (Exception ex)
                {
                    ...
                    ExceptionBlock.Text = "Failed to update collective: " + ex;
                }
            }
            else
            {
